...
body {
	background: var(--grey);
	overflow-x: hidden;
	background-image: url(./img/acc1.jpeg);
...
<body>
	...
	<section id="sidebar">
		<a href="#" class="brand">
			...
			<span class="text">Utilisateur IT</span>
		</a>
		<ul class="side-menu top">
			<li class="active">
				<a href="#">
					<i class='bx bxs-dashboard' ></i>
					<span class="text">Acceuille</span>
				</a>
			</li>
			
			<li>
				<a href="./materiels_stock/afficher_materiels.php">
					<i class='bx bxs-doughnut-chart' ></i>
					<span class="text">Stock</span>
				</a>
			</li>
			<li>
				<a href="./utilsateurs/utilisateurs.php">
		...
		<ul class="side-menu">
			<li>
				<a href="change_password.php" class="logout">
